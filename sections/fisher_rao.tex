...
\begin{equation}
  ...
  \label{eq:psi_signed}
\end{equation}
so that $\psi \in \mathbb{R}$ for all $(\tau,\rho)$ in the physical domain and $\psi = 0 \Leftrightarrow \rho = 0$.  \Cref{fig:psi_partition} (right) plots this signed extension against $u=\rho\,\sech\tau$.
