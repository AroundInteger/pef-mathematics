...
%
% Companion paper to pef-empirical/.
...
% and numerical validation (§7 CSVs from validation_inputs/).
% Empirical paper submits first; companion preprints around the same time.
...
\input{sections/canonical_form}
\input{sections/mobius_chebyshev}
\input{sections/sphere_realisation}
\input{sections/partition_function}
\input{sections/fisher_rao}
